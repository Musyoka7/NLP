"""Fine-tune ClimateBERT for climate stance classification.
Run with: python scripts/train_climatebert.py

Same pipeline as scripts/train_distilbert.py — only the model checkpoint changes.
Model: climatebert/distilroberta-base-climate-f (Webersinke et al. 2022).
"""
